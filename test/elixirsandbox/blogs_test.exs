defmodule Elixirsandbox.BlogsTest do
  use Elixirsandbox.DataCase

  alias Elixirsandbox.Blogs

  describe "articles" do
    alias Elixirsandbox.Blogs.Article

    import Elixirsandbox.BlogsFixtures
  ...
  describe "comments" do
    alias Elixirsandbox.Blogs.Comment
